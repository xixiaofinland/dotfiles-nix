      ...
      in
        pkgs.mkShell {
          ...
          shellHook = ''
            ...
            export_alias tt "cargo t all  -- --show-output"
            export_alias tp "cargo t prettier -- --show-output"
            export_alias te "cargo t extra -- --show-output"
            export_alias tm "cargo t manual -- --show-output"
